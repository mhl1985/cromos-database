...
--   del proyecto Cromos Database.
--
-- Funcionamiento:
--   1. Elimina la base de datos si ya existe.
--   2. Crea de nuevo la base de datos.
--   3. Selecciona la base de datos.
--   4. Crea todas las tablas respetando el orden de dependencias.
--
-- IMPORTANTE:
--   Este script borra completamente la base de datos cromos_database
--   antes de volver a crearla.
-- =========================================================
...
-- =========================================================
-- Script: 02_use_database.sql
--
-- Descripción:
--   Selecciona la base de datos del proyecto para que las
--   siguientes sentencias SQL se ejecuten sobre ella.
-- =========================================================
