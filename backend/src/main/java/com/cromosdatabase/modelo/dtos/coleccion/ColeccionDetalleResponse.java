...
/**
 * DTO de respuesta detallada para una colección.
 *
 * Se utiliza en el endpoint de detalle de colección.
 *
 * TODO futuro:
 * - Añadir listado de cromos de la colección.
 * - Añadir información específica del usuario sobre la colección.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ColeccionDetalleResponse {
